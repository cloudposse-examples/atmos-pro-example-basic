...
For more on setting this up with our reference architecture, please see [Initializing the Terraform State S3 Backend](https://docs.cloudposse.com/layers/accounts/initialize-tfstate/).
